    ...
    if (user.type === 'entreprise') {
      return [
        {
          ...
          description: 'Accédez à votre espace personnel et consultez vos statistiques',
        ...
        },
        {
          ...
          description: 'Créer une demande de partenariat avec un lycée professionnel',
        ...
        },
        {
          ...
          description: 'Explorez notre base de données de lycées professionnels',
      ...
      return [
        ...
        },
        {
          ...
          description: 'Modifiez les détails et spécialités de votre établissement',
        ...
        <div className="fr-container">
          <div className="fr-grid-row fr-grid-row--center">
            <div className="fr-col-12 fr-col-md-10 fr-col-lg-8">
              ...
              {!isAuthenticated ? (
                ...
                <div className="fr-mb-6w">
                  <h3 className="fr-h3 fr-mb-4w">
                    <span className="fr-icon-user-line fr-mr-2w" aria-hidden="true"></span>
                        ...
                        <div className="fr-card__body">
                          <div className="fr-card__content">
                            ...
                            <p className="fr-card__desc">
                              Je souhaite créer des partenariats avec des lycées professionnels pour des stages, alternances ou projets collaboratifs.
                            </p>
                      ...
                      >
                        <div className="fr-card__body">
                          <div className="fr-card__content">
                            ...
                            <p className="fr-card__desc">
                              Je représente un établissement et je souhaite développer des partenariats avec les entreprises locales et nationales.
                            </p>
                            <div className="fr-card__footer">
                              <button 
                                className="fr-btn fr-btn--lg fr-btn--icon-left fr-icon-login-box-line"
                ...
                <div className="fr-mb-6w">
                  <div className="fr-callout fr-callout--success">
                    ...
                    <p className="fr-callout__text">
                      Bienvenue <strong>{user?.name}</strong> ! Accédez rapidement à vos fonctionnalités principales.
                    </p>
                  </div>
                  ...
                  <div className="fr-mt-6w">
                    <h4 className="fr-h4 fr-mb-4w">
                      <span className="fr-icon-lightning-line fr-mr-2w" aria-hidden="true"></span>
                      Actions rapides
                    </h4>
                                   ...
                                   <div className="fr-col-auto">
                                     <div 
                                       style={{ 
                                         ...
                                         height: '80px',
                                         borderRadius: '12px',
                                         backgroundColor: action.color === 'primary' ? '#f0f0ff' : 
                                                        action.color === 'success' ? '#f0fff4' :
                                                        action.color === 'info' ? '#f0f8ff' :
                                                        action.color === 'warning' ? '#fff8f0' : '#f5f5f5',
                                         display: 'flex',
                                         alignItems: 'center',
                                     ...
                                     >
                                       <span 
                                         ...
                                         style={{ 
                                           fontSize: '2rem',
                                           color: action.color === 'primary' ? '#000091' : 
                                                  action.color === 'success' ? '#18753c' :
                                                  action.color === 'info' ? '#0063cb' :
                                                  action.color === 'warning' ? '#b34000' : '#666'
                                         }}
                                       ></span>
                                     </div>
                                   </div>
                                   ...
                                   <div className="fr-col-auto">
                                     <span 
                                       className={`fr-btn ${
                                         ...
                                         action.color === 'success' ? 'fr-btn--success' :
                                         action.color === 'info' ? 'fr-btn--tertiary' :
                                         'fr-btn--secondary'
              ...
              <div className="fr-btns-group fr-btns-group--center fr-mt-6w">
                <a 
          ...
          <div className="fr-grid-row fr-grid-row--center fr-mb-6w">
            <div className="fr-col-12 fr-col-lg-8">
              <h2 className="fr-h2 fr-mb-4w fr-text--center">
                <span className="fr-icon-tools-line fr-mr-2w" aria-hidden="true"></span>
                ...
                <div className="fr-card__body">
                  <div className="fr-card__content fr-text--center">
                    <div className="fr-mb-3w">
                      <span 
                        className="fr-icon-database-2-line" 
                        aria-hidden="true"
                    ...
                    <p className="fr-card__desc">
                      <strong>Algorithme de correspondance automatique</strong> entre les besoins des entreprises et les spécialités des lycées professionnels.
                    </p>
              ...
              >
                <div className="fr-card__body">
                  <div className="fr-card__content fr-text--center">
                    ...
                    <p className="fr-card__desc">
                      <strong>Trouvez les partenaires les plus proches</strong> géographiquement pour faciliter les échanges et réduire les déplacements.
                    </p>
                    <div className="fr-mt-3w">
              ...
              >
                <div className="fr-card__body">
                  <div className="fr-card__content fr-text--center">
                    ...
                    <p className="fr-card__desc">
                      <strong>Dashboard complet</strong> pour suivre l&apos;évolution de vos demandes et collaborations en cours avec des statistiques détaillées.
                    </p>
                    <div className="fr-mt-3w">
          ...
          <div className="fr-grid-row fr-grid-row--center">
            <div className="fr-col-12 fr-col-lg-10">
              <h3 className="fr-h3 fr-mb-4w fr-text--center">
                <span className="fr-icon-heart-line fr-mr-2w" aria-hidden="true"></span>
                  ...
                  <div className="fr-callout">
                    ...
                    <ul style={{ listStyle: 'none', paddingLeft: 0 }}>
                      <li className="fr-mb-1w">
                        <span className="fr-icon-arrow-right-line fr-mr-1w" aria-hidden="true"></span>
              ...
              <div className="fr-grid-row fr-grid-row--center fr-mt-6w">
                <div className="fr-col-12 fr-col-md-8">
                  <div className="fr-card fr-card--horizontal fr-card--blue-ecume fr-card--shadow">
                    <div className="fr-card__body">
                      <div className="fr-card__content fr-text--center">
                        <h4 className="fr-card__title">
                          <span className="fr-icon-rocket-line fr-mr-2w" aria-hidden="true"></span>
                          Prêt à commencer ?
                        </h4>
                        <p className="fr-card__desc">
                        ...
                        <div className="fr-btns-group fr-btns-group--center">
                          <button 
                            className="fr-btn fr-btn--secondary fr-btn--lg fr-btn--icon-left fr-icon-building-line"
                            onClick={() => router.push('/auth?type=entreprise')}
                            title="Inscription entreprise - Trouvez des lycées partenaires"
                          >
                          ...
                          <button 
                            ...
                            onClick={() => router.push('/auth?type=lycee')}
                            title="Inscription lycée - Développez vos partenariats"
                          >
                            Je suis un lycée
                          </button>
                        </div>
